...
<!-- Snake SVGs are generated by .github/workflows/snake.yml → output branch (first run: Actions tab → Generate contribution snake → Run workflow) -->
<picture>
